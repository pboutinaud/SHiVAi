...
from shivautils.workflows.recalage_dual_ants import genWorkflow
...
wfargs = {'SUBJECT_LIST': os.listdir(subject_dict),
          'BASE_DIR': out_dir,
          'PVS_DESCRIPTOR': os.path.join(args.model, 'model_info/T1.FLAIR-PVS/model_info.json'),
          'WMH_DESCRIPTOR': os.path.join(args.model, 'model_info/T1.FLAIR-WMH/model_info.json'),
...
wf.get_node('dataGrabber').inputs.template_args = {'t1_fealinx': [['subject_id', 't1_fealinx']],
