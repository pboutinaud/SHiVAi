...
Apptainer is a container solution, meaning that you can run SHiVAi using an Apptainer image (a file with the *.sif* extension) containing all the software and environment necessary. You can get the SHiVAi image from us [https://cloud.efixia.com/sharing/bbWPx1QAZ](https://cloud.efixia.com/sharing/bbWPx1QAZ) or build it yourself.
