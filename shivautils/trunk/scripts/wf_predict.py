...
from shivautils.workflows.wf_predict import genWorkflow
...
wfargs = {'SUBJECT_LIST': os.listdir(subject_dict),
          ...
          'DESCRIPTOR': os.path.join(args.model, 'T1.FLAIR-PVS/V0/model_info.json'),
...
if args.gpu:
    wf.get_node('predict').inputs.gpu_number = args.gpu
