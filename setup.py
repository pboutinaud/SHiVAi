...
setup(name='shivautils',
      ...
      scripts=[join("scripts", "script_wf.py"),
               join("scripts", "test.py"),
               join("scripts", "script_dual_recalage.py"),
               join("scripts", "script_specifics.py"),
               join("scripts", "wf_BIDS.py"),
               join("scripts", "wf_predict.py"),
               ...
               join("scripts", "preproc_brainmask.py"),
               join("scripts", "wf_dual_brainmask.py"),
               join("scripts", "wf_brainmask.py"),
